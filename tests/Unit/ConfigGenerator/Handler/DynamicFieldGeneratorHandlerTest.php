...
class DynamicFieldGeneratorHandlerTest extends TestCase
{
    ...
    {
        $closure = \Closure::fromCallable([new PrepareCallable(), 'prepareSolrResponse']);
        $combine = array_combine(DynamicFieldGeneratorHandler::$attributes, DynamicFieldGeneratorHandler::$attributes);
    ...
    {
        self::assertTrue((new DynamicFieldGeneratorHandler())->supports(ConfigGenerator::TYPE_DYNAMIC_FIELD));
        self::assertFalse((new DynamicFieldGeneratorHandler())->supports(ConfigGenerator::TYPE_FIELD_TYPE));
    }
