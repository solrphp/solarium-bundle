...
class FieldGeneratorHandlerTest extends TestCase
{
    ...
    {
        self::assertTrue((new FieldGeneratorHandler())->supports(ConfigGenerator::TYPE_FIELD));
        self::assertFalse((new FieldGeneratorHandler())->supports(ConfigGenerator::TYPE_FIELD_TYPE));
    }
