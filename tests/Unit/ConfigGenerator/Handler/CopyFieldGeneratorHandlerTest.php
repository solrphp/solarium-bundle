...
class CopyFieldGeneratorHandlerTest extends TestCase
{
    ...
    {
        self::assertTrue((new CopyFieldGeneratorHandler())->supports(ConfigGenerator::TYPE_COPY_FIELD));
        self::assertFalse((new CopyFieldGeneratorHandler())->supports(ConfigGenerator::TYPE_FIELD_TYPE));
    }
