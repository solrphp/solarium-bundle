...
use Solrphp\SolariumBundle\ConfigGenerator\Handler\Schema\FieldTypeGeneratorHandler;
...
class FieldTypeGeneratorHandlerTest extends TestCase
{
    ...
    {
        self::assertTrue((new FieldTypeGeneratorHandler($this->getVisitors()))->supports(SchemaConfigurationGenerator::TYPE_FIELD_TYPE));
        self::assertFalse((new FieldTypeGeneratorHandler($this->getVisitors()))->supports(SchemaConfigurationGenerator::TYPE_COPY_FIELD));
    }
