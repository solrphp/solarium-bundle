...
class RequestDispatcherGeneratorHandlerTest extends TestCase
{
    ...
    {
        self::assertTrue((new RequestDispatcherGeneratorHandler($this->getVisitors()))->supports(ConfigGenerator::TYPE_REQUEST_DISPATCHER));
        self::assertFalse((new RequestDispatcherGeneratorHandler($this->getVisitors()))->supports(ConfigGenerator::TYPE_COPY_FIELD));
    }
