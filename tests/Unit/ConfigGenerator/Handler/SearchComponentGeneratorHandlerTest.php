...
class SearchComponentGeneratorHandlerTest extends TestCase
{
    ...
    {
        self::assertTrue((new SearchComponentGeneratorHandler())->supports(ConfigGenerator::TYPE_SEARCH_COMPONENT));
        self::assertFalse((new SearchComponentGeneratorHandler())->supports(ConfigGenerator::TYPE_COPY_FIELD));
    }
