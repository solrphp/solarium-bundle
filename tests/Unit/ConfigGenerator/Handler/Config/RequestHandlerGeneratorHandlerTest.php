...
use Solrphp\SolariumBundle\ConfigGenerator\Handler\Config\RequestHandlerGeneratorHandler;
...
class RequestHandlerGeneratorHandlerTest extends TestCase
{
    ...
    {
        self::assertTrue((new RequestHandlerGeneratorHandler($this->getVisitors()))->supports(ConfigConfigurationGenerator::TYPE_REQUEST_HANDLER));
        self::assertFalse((new RequestHandlerGeneratorHandler($this->getVisitors()))->supports(SchemaConfigurationGenerator::TYPE_COPY_FIELD));
    }

    /**
     * @return \Generator<array<array<\Solrphp\SolariumBundle\ConfigGenerator\Contract\ConfigGeneratorVisitorInterface>|null>>
     */
