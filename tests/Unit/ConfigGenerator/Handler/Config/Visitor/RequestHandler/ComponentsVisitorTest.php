...
/**
 * ComponentsVisitorTest.
 *
 * @author wicliff <wicliff.wolda@gmail.com>
 */
class ComponentsVisitorTest extends TestCase
{
    /**
    ...
    public function testVisit(): void
    {
        ...
        (new ComponentsVisitor())->visit($crawler, $closure, $node);

        self::assertArrayHasKey('components', $node);
        self::assertContains('nameOfCustomComponent2', $node['components']);
    }
