...
use Solrphp\SolariumBundle\ConfigGenerator\Handler\Config\UpdateHandlerGeneratorHandler;
...
class UpdateHandlerGeneratorHandlerTest extends TestCase
{
    ...
    {
        self::assertTrue((new UpdateHandlerGeneratorHandler())->supports(ConfigConfigurationGenerator::TYPE_UPDATE_HANDLER));
        self::assertFalse((new UpdateHandlerGeneratorHandler())->supports(SchemaConfigurationGenerator::TYPE_COPY_FIELD));
    }
