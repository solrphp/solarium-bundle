...
class QueryGeneratorHandlerTest extends TestCase
{
    ...
    {
        self::assertTrue((new QueryGeneratorHandler($this->getVisitors()))->supports(ConfigGenerator::TYPE_QUERY));
        self::assertFalse((new QueryGeneratorHandler($this->getVisitors()))->supports(ConfigGenerator::TYPE_COPY_FIELD));
    }
