...
/**
 * Limit Token Count Filter Test.
 *
 * @author wicliff <wicliff.wolda@gmail.com>
 */
final class LimitTokenCountFilterTest extends TestCase
{
    private static $class = 'Solrphp\\SolariumBundle\\SolrApi\\Schema\\Model\\Filter\\LimitTokenCountFilter';
    ...
    private static $accessors = [
        ...
        'maxTokenCount' => [
            'reader' => 'getMaxTokenCount',
            'writer' => 'setMaxTokenCount',
            'remover' => null,
        ],
        'consumeAllTokens' => [
     ...
     */
    public function testLimitTokenCountFilterReadWritePropertiesMethods(): void
    {
