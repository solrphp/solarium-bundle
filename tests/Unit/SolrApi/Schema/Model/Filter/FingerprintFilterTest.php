 ...
 */
final class FingerprintFilterTest extends TestCase
{
    private static $class = 'Solrphp\\SolariumBundle\\SolrApi\\Schema\\Model\\Filter\\FingerprintFilter';

    private $values = [
        'class' => 'foo',
        'separator' => 'foo',
        'maxOutputTokenSize' => 5,
    ];
    ...
    private static $accessors = [
        ...
        'maxOutputTokenSize' => [
            'reader' => 'getMaxOutputTokenSize',
            'writer' => 'setMaxOutputTokenSize',
            'remover' => null,
        ],
    ];
     ...
     */
    public function testFingerprintFilterReadWritePropertiesMethods(): void
    {
