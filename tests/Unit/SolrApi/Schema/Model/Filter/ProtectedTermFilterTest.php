...
/**
 * Protected Term Filter Test.
 *
 * @author wicliff <wicliff.wolda@gmail.com>
 */
final class ProtectedTermFilterTest extends TestCase
{
    private static $class = 'Solrphp\\SolariumBundle\\SolrApi\\Schema\\Model\\Filter\\ProtectedTermFilter';
    ...
    private static $accessors = [
        ...
        'wrappedFilters' => [
            'reader' => 'getWrappedFilters',
            'writer' => 'setWrappedFilters',
            'remover' => null,
        ],
        'ignoreCase' => [
     ...
     */
    public function testProtectedTermFilterReadWritePropertiesMethods(): void
    {
