...
/**
 * Limit Token Offset Filter Test.
 *
 * @author wicliff <wicliff.wolda@gmail.com>
 */
final class LimitTokenOffsetFilterTest extends TestCase
{
    private static $class = 'Solrphp\\SolariumBundle\\SolrApi\\Schema\\Model\\Filter\\LimitTokenOffsetFilter';
    ...
    private static $accessors = [
        ...
        'maxStartOffset' => [
            'reader' => 'getMaxStartOffset',
            'writer' => 'setMaxStartOffset',
            'remover' => null,
        ],
        'consumeAllTokens' => [
     ...
     */
    public function testLimitTokenOffsetFilterReadWritePropertiesMethods(): void
    {
