 ...
 */
final class ShingleFilterTest extends TestCase
{
    private static $class = 'Solrphp\\SolariumBundle\\SolrApi\\Schema\\Model\\Filter\\ShingleFilter';
    ...
    private static $accessors = [
        ...
        'minShingleSize' => [
            'reader' => 'getMinShingleSize',
            'writer' => 'setMinShingleSize',
            'remover' => null,
        ],
        'maxShingleSize' => [
            'reader' => 'getMaxShingleSize',
            'writer' => 'setMaxShingleSize',
            'remover' => null,
        ],
        'outputUnigrams' => [
            'reader' => 'getOutputUnigrams',
            'writer' => 'setOutputUnigrams',
            'remover' => null,
        ],
        'outputUnigramsIfNoShingles' => [
            'reader' => 'getOutputUnigramsIfNoShingles',
            'writer' => 'setOutputUnigramsIfNoShingles',
            'remover' => null,
        ],
        'tokenSeparator' => [
            'reader' => 'getTokenSeparator',
            'writer' => 'setTokenSeparator',
            'remover' => null,
        ],
    ];
     ...
     */
    public function testShingleFilterReadWritePropertiesMethods(): void
    {
