...
/**
 * Reversed Wildcard Filter Test.
 *
 * @author wicliff <wicliff.wolda@gmail.com>
 */
final class ReversedWildcardFilterTest extends TestCase
{
    private static $class = 'Solrphp\\SolariumBundle\\SolrApi\\Schema\\Model\\Filter\\ReversedWildcardFilter';
    ...
    private $values = [
        ...
        'maxPosAsterisk' => 3,
        'maxPosQuestion' => 2,
        'maxFractionAsterisk' => 0.85486753464437,
        'minTrailing' => 4,
    ];
    ...
    private static $accessors = [
        ...
        'withOriginal' => [
            'reader' => 'getWithOriginal',
            'writer' => 'setWithOriginal',
            'remover' => null,
        ],
        'maxPosAsterisk' => [
            'reader' => 'getMaxPosAsterisk',
            'writer' => 'setMaxPosAsterisk',
            'remover' => null,
        ],
        'maxPosQuestion' => [
            'reader' => 'getMaxPosQuestion',
            'writer' => 'setMaxPosQuestion',
            'remover' => null,
        ],
        'maxFractionAsterisk' => [
            'reader' => 'getMaxFractionAsterisk',
            'writer' => 'setMaxFractionAsterisk',
            'remover' => null,
        ],
        'minTrailing' => [
            'reader' => 'getMinTrailing',
            'writer' => 'setMinTrailing',
            'remover' => null,
        ],
    ];
     ...
     */
    public function testReversedWildcardFilterReadWritePropertiesMethods(): void
    {
