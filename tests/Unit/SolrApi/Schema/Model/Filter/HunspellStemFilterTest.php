...
/**
 * Hunspell Stem Filter Test.
 *
 * @author wicliff <wicliff.wolda@gmail.com>
 */
final class HunspellStemFilterTest extends TestCase
{
    private static $class = 'Solrphp\\SolariumBundle\\SolrApi\\Schema\\Model\\Filter\\HunspellStemFilter';
    ...
    private static $accessors = [
        ...
        'strictAffixParsing' => [
            'reader' => 'getStrictAffixParsing',
            'writer' => 'setStrictAffixParsing',
            'remover' => null,
        ],
    ];
     ...
     */
    public function testHunspellStemFilterReadWritePropertiesMethods(): void
    {
