...
/**
 * Pattern Replace Filter Test.
 *
 * @author wicliff <wicliff.wolda@gmail.com>
 */
final class PatternReplaceFilterTest extends TestCase
{
    private static $class = 'Solrphp\\SolariumBundle\\SolrApi\\Schema\\Model\\Filter\\PatternReplaceFilter';
    ...
    private static $accessors = [
        ...
        'replacement' => [
            'reader' => 'getReplacement',
            'writer' => 'setReplacement',
            'remover' => null,
        ],
        'replace' => [
            'reader' => 'getReplace',
     ...
     */
    public function testPatternReplaceFilterReadWritePropertiesMethods(): void
    {
