...
/**
 * Double Metaphone Filter Test.
 *
 * @author wicliff <wicliff.wolda@gmail.com>
 */
final class DoubleMetaphoneFilterTest extends TestCase
{
    private static $class = 'Solrphp\\SolariumBundle\\SolrApi\\Schema\\Model\\Filter\\DoubleMetaphoneFilter';
    ...
    private static $accessors = [
        ...
        'maxCodeLength' => [
            'reader' => 'getMaxCodeLength',
            'writer' => 'setMaxCodeLength',
            'remover' => null,
        ],
    ];
     ...
     */
    public function testDoubleMetaphoneFilterReadWritePropertiesMethods(): void
    {
