...
/**
 * Synonym Graph Filter Test.
 *
 * @author wicliff <wicliff.wolda@gmail.com>
 */
final class SynonymGraphFilterTest extends TestCase
{
    private static $class = 'Solrphp\\SolariumBundle\\SolrApi\\Schema\\Model\\Filter\\SynonymGraphFilter';
    ...
    private static $accessors = [
        ...
        'ignoreCase' => [
            'reader' => 'getIgnoreCase',
            'writer' => 'setIgnoreCase',
            'remover' => null,
        ],
        'expand' => [
            'reader' => 'getExpand',
        ...
        'tokenizerFactory' => [
            'reader' => 'getTokenizerFactory',
            'writer' => 'setTokenizerFactory',
            'remover' => null,
        ],
        'analyzer' => [
            'reader' => 'getAnalyzer',
     ...
     */
    public function testSynonymGraphFilterReadWritePropertiesMethods(): void
    {
