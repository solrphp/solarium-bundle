...
/**
 * Limit Token Position Filter Test.
 *
 * @author wicliff <wicliff.wolda@gmail.com>
 */
final class LimitTokenPositionFilterTest extends TestCase
{
    private static $class = 'Solrphp\\SolariumBundle\\SolrApi\\Schema\\Model\\Filter\\LimitTokenPositionFilter';
    ...
    private static $accessors = [
        ...
        'maxTokenPosition' => [
            'reader' => 'getMaxTokenPosition',
            'writer' => 'setMaxTokenPosition',
            'remover' => null,
        ],
        'consumeAllTokens' => [
            'reader' => 'getConsumeAllTokens',
            'writer' => 'setConsumeAllTokens',
            'remover' => null,
        ],
    ];
     ...
     */
    public function testLimitTokenPositionFilterReadWritePropertiesMethods(): void
    {
