...
/**
 * Numeric Payload Token Filter Test.
 *
 * @author wicliff <wicliff.wolda@gmail.com>
 */
final class NumericPayloadTokenFilterTest extends TestCase
{
    private static $class = 'Solrphp\\SolariumBundle\\SolrApi\\Schema\\Model\\Filter\\NumericPayloadTokenFilter';

    private $values = [
        'class' => 'foo',
        'payload' => 0.91236368003877,
        'typeMatch' => 'foo',
    ];

    private static $nonNullable = [
        'class' => 'foo',
        'payload' => 0.86493315820812,
        'typeMatch' => 'foo',
    ];
     ...
     */
    public function testNumericPayloadTokenFilterReadWritePropertiesMethods(): void
    {
