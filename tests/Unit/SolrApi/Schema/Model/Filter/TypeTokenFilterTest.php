...
/**
 * Type Token Filter Test.
 *
 * @author wicliff <wicliff.wolda@gmail.com>
 */
final class TypeTokenFilterTest extends TestCase
{
    private static $class = 'Solrphp\\SolariumBundle\\SolrApi\\Schema\\Model\\Filter\\TypeTokenFilter';
    ...
    private static $accessors = [
        ...
        'useWhitelist' => [
            'reader' => 'getUseWhitelist',
            'writer' => 'setUseWhitelist',
            'remover' => null,
        ],
        'enablePositionIncrements' => [
            'reader' => 'getEnablePositionIncrements',
            'writer' => 'setEnablePositionIncrements',
            'remover' => null,
        ],
    ];
     ...
     */
    public function testTypeTokenFilterReadWritePropertiesMethods(): void
    {
