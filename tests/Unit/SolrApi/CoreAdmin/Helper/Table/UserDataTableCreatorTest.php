...
/**
 * User DataTable CreatorTest.
 *
 * @author wicliff <wicliff.wolda@gmail.com>
 */
class UserDataTableCreatorTest extends TestCase
{
    /**
     * @var false|resource
     */
    ...
    public function testCreate()
    {
        ...
        $expected = <<<TABLE
┌──────┬──────── user data ────────────────┐
│ core │ commitCommandVer │ commitTimeMSec │
├──────┼──────────────────┼────────────────┤
│ foo  │ foo              │ bar            │
└──────┴──────────────────┴────────────────┘
...
TABLE;
        ...
        (new UserDataTableCreator())->create($output = $this->getOutputStream(), $response)->render();
