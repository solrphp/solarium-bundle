...
/**
 * StatusTable Creator Test.
 *
 * @author wicliff <wicliff.wolda@gmail.com>
 */
class StatusTableCreatorTest extends TestCase
{
    /**
     * @var false|resource
     */
    ...
    public function testCreate()
    {
        ...
        $expected = <<<TABLE
┌──────┬─────────────┬─────────┬─────── status ──┬───────────────────────────┬────────┐
│ name │ instanceDir │ dataDir │ config │ schema │ startTime                 │ uptime │
├──────┼─────────────┼─────────┼────────┼────────┼───────────────────────────┼────────┤
│ foo  │ qux         │ baz     │ bar    │ quux   │ 1970-01-01T00:00:00+00:00 │ 3      │
└──────┴─────────────┴─────────┴────────┴────────┴───────────────────────────┴────────┘

TABLE;

        (new StatusTableCreator())->create($output = $this->getOutputStream(), $response)->render();
